...
- 과제 내용
- Enter 키를 눌러 아이디 입력 후 비밀번호 입력창으로 이동하도록 구현
- 비밀번호 입력창에서 Enter 키를 누르면 로그인 버튼이 실행되도록 만들
- 전체 지우기 버튼과 비밀번호 표시 기능을 추가

- 구현 내용과 기능 설명
- 아이디 입력 후 Enter를 누르면 비밀번호 입력창으로 포커스가 이동한다
- 비밀번호 입력 후 Enter를 누르면 로그인 기능이 실행된다
- 전체 지우기 버튼을 누르면 입력창과 에러 메시지가 초기화된다
- 체크박스를 사용하여 비밀번호를 보이거나 숨길 수 있다